...
<head>
    <title>Nura Admin - Calendar</title>
    <meta name="description" content="Calendar | Nura Admin">
    <meta charset="utf-8">
    ...
    <link href="assets/plugins/fullcalendar/packages/list/main.css" rel="stylesheet" />
...
<body class="adminbody">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="calendar.jsp">Calendar</a>
                                </li>
                                <li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>You can find examples and documentation about Full Calendar plugin here:
                            <a target="_blank" href="https://fullcalendar.io/">Full Calendar documentation</a>
                        </p>
                    </div>
    ...
    <script src="assets/plugins/fullcalendar/packages/list/main.js"></script>
    <script>
