...
<head>
    <title>Nura Admin - Date and time picker</title>
    <meta name="description" content="Date and time picker | Nura Admin">
    <meta charset="utf-8">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="forms-datetime-picker.jsp">Date and Time Picker</a>
                                </li>
                                <li>
