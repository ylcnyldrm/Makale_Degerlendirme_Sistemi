...
<head>
    <title>Nura Admin - Fancybox</title>
    <meta name="description" content="Fancybox | Nura Admin">
    <meta charset="utf-8">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                <li class="active">
                                    <a class="active" href="media-fancybox.jsp">
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <a data-fancybox class="btn btn-danger mb-3" href="https://via.placeholder.com/500x350?text=Replace with video url" role="button">YouTube video</a>
                                    <a data-fancybox class="btn btn-danger mb-3" href="https://via.placeholder.com/500x350?text=Replace with video url" role="button">Vimeo video</a>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <a data-fancybox="ajax" data-src="assets/plugins/fancybox/ajax.jsp" data-type="ajax" class="btn btn-danger mb-3" role="button" href="javascript:;">Ajax request</a>
                                    <a data-fancybox="iframe" data-src="assets/plugins/fancybox/iframe.jsp" data-type="iframe" class="btn btn-danger mb-3" role="button" href="javascript:;">Iframed page</a>
                                </div>
                            </div><!-- end card-->
                        </div>
                    ...
                    <div id="modal" style="display: none; padding: 50px 5vw; max-width: 800px;text-align: center;">
                        ...
                        <p>This is a sample login form, but you may put any HTML here. <br />For example, a link to <a href="https://mozilla.github.io/pdf.js/web/viewer.jsp" data-fancybox data-type="pdf">PDF file</a>
