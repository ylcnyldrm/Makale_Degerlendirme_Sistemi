...
<head>
    <title>Nura Admin - Image Magnify</title>
    <meta name="description" content="Image Magnify | Nura Admin">
    <meta charset="utf-8">
...
<body class="adminbody">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="media-image-magnifier.jsp">Image Magnifier</a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">Image Magnify</h1>
                                <ol class="breadcrumb float-right">
                                    <li class="breadcrumb-item">Home</li>
                                    <li class="breadcrumb-item active">Image Magnify</li>
                                </ol>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="fas fa-search"></i> Example 1</h3>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="fas fa-search"></i> Example 2</h3>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="fas fa-search"></i> Example 3</h3>
                                </div>
                    ...
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>You can find examples and documentation about Bootstrap Image Magnify here:
                            <a target="_blank" href="https://github.com/marcaube/bootstrap-magnify">Bootstrap Image Magnify</a>
                        </p>
                    </div>
    ...
    <script src="assets/plugins/bootstrap-magnify/bootstrap-magnify.min.js"></script>
