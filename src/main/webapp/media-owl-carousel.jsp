...
<head>
    <title>Nura Admin - OWL Carousel</title>
    <meta name="description" content="OWL Carousel | Nura Admin">
    <meta charset="utf-8">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="media-owl-carousel.jsp">Owl Carousel</a>
                                </li>
                                <li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>Owl Carousel 2 lets you create a beautiful responsive carousel slider. You can find examples and documentation about Owl Carousel 2 here:
                            <a target="_blank" href="https://owlcarousel2.github.io/OwlCarousel2">Owl Carousel 2</a>.
                        </p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="far fa-image"></i> Responsive Carousel</h3>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="owl-1 owl-carousel owl-theme">
                                        <div class="item">
                                            <img class="d-block w-100" src="https://via.placeholder.com/600x350" alt="slide">
                                        </div>
                                        <div class="item">
                                            <img class="d-block w-100" src="https://via.placeholder.com/600x350" alt="slide">
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="far fa-image"></i> Lazy Load</h3>
                                </div>

                                <div class="card-body">

                                    <div class="owl-2 owl-carousel owl-theme">
                                        <img src="#" alt="image" class="owl-lazy" data-src="https://via.placeholder.com/600x350">
                                        <img src="#" alt="image" class="owl-lazy" data-src="https://via.placeholder.com/600x350">
                                        <img src="#" alt="image" class="owl-lazy" data-src="https://via.placeholder.com/600x350">
                                        <img src="#" alt="image" class="owl-lazy" data-src="https://via.placeholder.com/600x350">
                                        <img src="#" alt="image" class="owl-lazy" data-src="https://via.placeholder.com/600x350">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3><i class="far fa-image"></i> Video</h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="owl-3 owl-carousel owl-theme">
                                        <div class="item-video" data-merge="3">
                                            <a class="owl-video" href="https://www.youtube.com/watch?v=HbYYA4iIsHw"></a>
                                        </div>
                                        <div class="item-video" data-merge="1">
                                            <a class="owl-video" href="https://www.youtube.com/watch?v=xWMMYhGWT88"></a>
                                        </div>
                                        <div class="item-video" data-merge="1">
                                            <a class="owl-video" href="https://www.youtube.com/watch?v=HbYYA4iIsHw"></a>
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="far fa-image"></i> Autoplay</h3>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="owl-4 owl-carousel owl-theme">
                                        ...
                                        <div class="item">
                                            <img class="d-block w-100" src="assets/images/sample-image-8.jpg" alt="slide">
                                        </div>
                                    </div>
