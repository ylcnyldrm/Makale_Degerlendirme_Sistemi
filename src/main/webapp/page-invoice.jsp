...
<head>
    <title>Nura Admin - Invoice</title>
    <meta name="description" content="Invoice | Nura Admin">
    <meta charset="utf-8">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="page-invoice.jsp">Invoice</a>
                                </li>
                                <li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="invoice-title text-center mb-3">
                                                    ...
                                                    <strong>Date:</strong> April 17, 2018
                                                </div>
                                                <hr>
                                                <div class="row">
