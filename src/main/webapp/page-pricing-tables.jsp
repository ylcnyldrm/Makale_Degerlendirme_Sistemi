...
<head>
    <title>Nura Admin - Pricing Tables</title>
    <meta name="description" content="Pricing Tables | Nura Admin">
    <meta charset="utf-8">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                <li class="active">
                                    <a class="active" href="page-pricing-tables.jsp">Pricing Tables</a>
                                </li>
                                <li>
