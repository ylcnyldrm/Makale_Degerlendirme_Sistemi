...
<head>
    <title>Nura Admin - Star rating</title>
    <meta name="description" content="Star rating | Nura Admin">
    <meta charset="utf-8">
    ...
    <link href="assets/plugins/star-rating/css/star-rating.min.css" rel="stylesheet" />
    <link href="assets/plugins/star-rating/themes/krajee-fas/theme.min.css" rel="stylesheet" />
...
<body class="adminbody">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                <li class="active">
                                    <a class="active" href="star-rating.jsp">Star Rating</a>
                                </li>
                                <li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="far fa-star"></i> Basic examples</h3>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="far fa-star"></i> Custom captions</h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <input id="input-1" name="input-1" class="fa-theme2 rating-loading" value="1" data-size="xs" data-min="0" data-max="5" data-step="1" data-show-clear="false" data-show-caption="true">
                                    <br />
                                    <input id="input-2" name="input-2" class="fa-theme2 rating-loading" value="2" data-size="xs" data-min="0" data-max="5" data-step="1" data-show-clear="false" data-show-caption="true">
                                    <br />
                                    <input id="input-3" name="input-3" class="fa-theme2 rating-loading" value="3" data-size="xs" data-min="0" data-max="5" data-step="1" data-show-clear="false" data-show-caption="true">
                                    <br />
                                    <input id="input-4" name="input-4" class="fa-theme2 rating-loading" value="4" data-size="xs" data-min="0" data-max="5" data-step="1" data-show-clear="false" data-show-caption="true">
                                    <br />
                                    <input id="input-5" name="input-5" class="fa-theme2 rating-loading" value="5" data-size="xs" data-min="0" data-max="5" data-step="1" data-show-clear="false" data-show-caption="true">
                    ...
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>You can find examples and documentation about Bootstrap star rating here:
                            <a target="_blank" href="http://plugins.krajee.com/star-rating">Bootstrap Star Rating</a>
                        </p>
                    </div>
    ...
    <script src="assets/plugins/star-rating/js/star-rating.min.js"></script>
    <script src="assets/plugins/star-rating/themes/krajee-fas/theme.min.js"></script>
    <script>
        jQuery(function ($) {
            $('.fa-theme').rating({
                theme: 'krajee-fas'
