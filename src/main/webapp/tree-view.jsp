...
<head>
    <title>Nura Admin - Tree view</title>
    <meta name="description" content="Tree view| Nura Admin">
    <meta charset="utf-8">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="tree-view.jsp">Tree View</a>
                                </li>
                                <li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="far fa-folder-open"></i> Simple Tree View</h3>
                                </div>
                                        ...
                                        <ul>
                                            <li>Admin
                                                <ul>
                                                    ...
                                                    <li data-jstree='{"icon":"far fa-folder-open"}'>Comments</li>
                                                    ...
                                                    <li data-jstree='{"icon":"far fa-user"}'>Users</li>
                                                </ul>
                                            </li>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="far fa-folder-open"></i> Tree View with Checkboxes</h3>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="fa fa-folder-open-o"></i> Tree View with drag & drop</h3>
                                </div>
                    ...
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>You can find examples and documentation about Tree Plugin here:
