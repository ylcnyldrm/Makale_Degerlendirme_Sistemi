...
<head>
    <title>Nura Admin - UI carousel</title>
    <meta name="description" content="UI carousel | Nura Admin">
    <meta charset="utf-8">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="ui-carousel.jsp">Carousel</a>
                                </li>
                                <li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>The carousel is a slideshow for cycling through a series of content, built with CSS 3D transforms and a bit of JavaScript. It works with a series of images, text, or custom markup. It also includes support for previous/next controls
                            and indicators. You can find examples and documentation about Bootstrap Carousels here: <a target="_blank" href="http://getbootstrap.com/docs/4.0/components/carousel/">Bootstrap Carousels
                                Documentation</a></p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3><i class="fas fa-file-image"></i> Carousel with controls</h3>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3><i class="fas fa-file-image"></i> Carousel with indicators and captions</h3>
                                    Add captions to your slides easily with the <i>.carousel-caption</i> element within any <i>.carousel-item</i>. They can be easily hidden on smaller viewports, as shown below, with optional display utilities. We hide
                                    them initially with <i>.d-none</i> and bring them back on medium-sized devices with <i>.d-md-block</i>.
                                </div>
