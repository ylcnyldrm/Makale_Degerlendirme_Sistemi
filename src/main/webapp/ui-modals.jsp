...
<head>
    <title>Nura Admin - UI modals</title>
    <meta name="description" content="UI modals | Nura Admin">
    <meta charset="utf-8">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="ui-modals.jsp">Modals</a>
                                </li>
                                <li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>Use Bootstrap's JavaScript modal plugin to add dialogs to your site for lightboxes, user notifications, or completely custom content. You can find examples and documentation about Bootstrap Modals here: <a target="_blank" href="http://getbootstrap.com/docs/4.3/components/modal/">Bootstrap Modals</a></p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3><i class="far fa-clone"></i> Default modals</h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <a role="button" href="#" class="btn btn-primary mb-2" data-toggle="modal" data-target="#exampleModal">
                                    ...
                                    <!-- Large modal -->
                                    <a role="button" href="#" class="btn btn-warning mb-2" data-toggle="modal" data-target=".bd-example-modal-lg">Large modal</a>
                                    ...
                                    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent molestie suscipit ultricies. Nunc non pulvinar tellus. Nunc varius non ante lobortis venenatis. Aenean enim urna, fermentum eget lectus quis, egestas rutrum dolor. Praesent rutrum eget
                                                    augue eget maximus. Vivamus vel orci vulputate quam tristique ultrices. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nam tincidunt bibendum suscipit.
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-primary">Save changes</button>
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    ...
                                    <!-- Small modal -->
                                    <a role="button" href="#" class="btn btn-danger mb-2" data-toggle="modal" data-target=".bd-example-modal-sm">Small modal</a>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3><i class="far fa-clone"></i> Custom modal</h3>
                                    Custom style for modal dialog.
                                </div>

                                <div class="card-body">

                                    <a href="#custom-modal" class="btn btn-primary mb-2" data-target="#customModal" data-toggle="modal">Open custom modal</a>
