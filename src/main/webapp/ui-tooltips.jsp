...
<head>
    <title>Nura Admin - UI tooltips and popovers</title>
    <meta name="description" content="UI tooltips and popovers | Nura Admin">
    <meta charset="utf-8">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="ui-tooltips.jsp">Tooltips and Popovers</a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">Tooltips</h1>
                    ...
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>Documentation and examples for adding custom Bootstrap tooltips with CSS and JavaScript using CSS3 for animations and data-attributes for local title storage.: <a target="_blank" href="http://getbootstrap.com/docs/4.3/components/tooltips/">Bootstrap Tooltips</a></p>

                        <h4 class="alert-heading">Popovers</h4>
                        <p>Documentation and examples for adding custom Bootstrap tooltips with CSS and JavaScript using CSS3 for animations and data-attributes for local title storage.: <a target="_blank" href="http://getbootstrap.com/docs/4.3/components/popovers/">Bootstrap Popovers</a></p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3><i class="far fa-comment"></i> Tooltips</h3>
                                    Hover over the buttons below to see their tooltips.
                                </div>

                                <div class="card-body">

                                    <button type="button" class="btn btn-secondary mb-2" data-toggle="tooltip" data-placement="top" title="Tooltip on top">
                                        Tooltip on top
                                    </button>
                                    <button type="button" class="btn btn-secondary mb-2" data-toggle="tooltip" data-placement="right" title="Tooltip on right">
                                        Tooltip on right
                                    </button>
                                    <button type="button" class="btn btn-secondary mb-2" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">
                                        Tooltip on bottom
                                    </button>
                                    <button type="button" class="btn btn-secondary mb-2" data-toggle="tooltip" data-placement="left" title="Tooltip on left">
                                        Tooltip on left
                                    </button>
                                    <div class="mb-2"></div>
                                    <a href="#" role="button" class="btn btn-info mb-2" data-toggle="tooltip" data-html="true" title="<em>Tooltip</em> <u>with</u> <b>HTML</b>">
                                        Tooltip with HTML
                                    </a>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3><i class="far fa-comment"></i> Popovers</h3>
                                    Four options are available: top, right, bottom, and left aligned.
                                </div>

                                <div class="card-body">

                                    <a role="button" href="#" class="btn btn-danger" data-toggle="popover" data-trigger="focus" data-placement="top" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?">Click
                                        to toggle popover</a>
