...
<head>
    <title>Nura Admin - Inbox</title>
    <meta name="description" content="Inbox | Nura Admin">
    <meta charset="utf-8">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      ResultSet rs =   vt.dbdenVeriCek("SELECT "+
							  ...
							  "makale_degerlendirme.makaleler.makale_ogretmen_id,  "+
                    		  ...
                    		  "where kabul_veya_ret_tarih IS NOT NULL");
                       while(rs.next()){
                       String tarih= rs.getString("kabul_veya_ret_tarih");  
                        ...
                        <a href="yonetici_mail_gonder.jsp?makale_ogretmen_id=<%=rs.getString("makale_ogretmen_id") %>" class="btn btn-danger btn-sm btn-block mt-2"><i class="fas fa-trash"></i> Mail Gönder</a>   
